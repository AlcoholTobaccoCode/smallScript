...
var RENDERER = {
	...
	setParameters : function(){
		...
		this.contextTwigs = $('<canvas style="z-index:1" />').attr({width : this.width, height : this.height}).appendTo(this.$container).get(0).getContext('2d');
